...
var A = base.A;
	...
	// var REGEX_VARS_REMOVED = /(.*-highlight|navbar-inverse-search-.*|fluid-grid-column-width1200|fluid-grid-column-width768|fluid-grid-column-width|fluid-grid-gutter-width1200|fluid-grid-gutter-width768|fluid-grid-gutter-width|grid-column-width1200|grid-column-width768|grid-column-width|grid-gutter-width1200|grid-gutter-width768|grid-row-width1200|grid-row-width768|grid-row-width)/g;
...
regexMap.MAP_CLASS_NAMES_CONVERT_HTML = A.merge(
...
regexMap.MAP_CLASS_NAMES_CONVERT_JS = A.merge(
	regexMap.MAP_CLASS_NAMES_CONVERT,
	{
		// Kinda dicey ones
		'visible-desktop': 'visible-md visible-lg',
...
regexMap.MAP_CLASS_NAMES_CONVERT_CSS = A.merge(
	regexMap.MAP_CLASS_NAMES_CONVERT,
	{
		// Kinda dicey ones
		'visible-desktop': 'visible-md.visible-lg',
